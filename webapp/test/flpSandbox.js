		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comempempproject7-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comempempproject7-display": {
								"semanticObject": "comempempproject7",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.emp.empproject7",
									"url": sap.ui.require.toUrl("com/emp/empproject7")
								}
							}
						}
					}
